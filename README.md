...
- Run on your project with no parameters, this will create the default configuration file
  - java -jar $HOME/.m2/repository/com/seanshubin/code/structure/code-structure-console/1.0.2/code-structure-console-1.0.2.jar
...
mvn org.apache.maven.plugins:maven-dependency-plugin:2.1:get \
    ...
    -Dartifact=com.seanshubin.code.structure:code-structure-console:1.0.2
```
