...
class Sample {
    ...
    fun path(
        ...
        filePrefix: String = "file-",
        fileSuffix: String = ""
    ): Path = Paths.get(pathName(dirPrefix, dirSuffix, filePrefix, fileSuffix))
    ...
    fun pathName(
        ...
        filePrefix: String = "file-",
        fileSuffix: String = ""
    ): String = "${dirName(dirPrefix, dirSuffix)}/${fileName(filePrefix, fileSuffix)}"
