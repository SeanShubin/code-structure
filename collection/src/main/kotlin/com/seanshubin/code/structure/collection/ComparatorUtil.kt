...
object ComparatorUtil {
    ...
    fun <T, U> comparingFirst(comparator: Comparator<T>): Comparator<Pair<T, U>> = Comparator { o1, o2 -> comparator.compare(o1.first, o2.first) }
    fun <T, U> comparingSecond(comparator: Comparator<U>): Comparator<Pair<T, U>> = Comparator { o1, o2 -> comparator.compare(o1.second, o2.second) }
}
